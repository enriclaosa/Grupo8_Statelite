...
accion_actual = None
media_en_arduino = False  # Indica si la media se calcula en Arduino o en Python
angulos = []
distancias = []
...
def CambiarMedia():
    ...
    RegistrarEvento("Comando:", f"Media calculada en {estado}")
...
MediaButton = Button(window, text="Media en Arduino", bg="lightblue", command=CambiarMedia)
MediaButton.grid(row=9, column=0, padx=5, pady=5, sticky=N+S+E+W)
