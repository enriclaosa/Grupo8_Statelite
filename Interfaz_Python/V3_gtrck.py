...
# Set initial plot limits groundtracks
ax.set_xlim(-7e6, 7e6)
ax.set_ylim(-7e6, 7e6)
...
GroundtrackFrame.grid(row=0, column=3, rowspan=8, padx=5, pady=5, sticky=N+S+E+W)
